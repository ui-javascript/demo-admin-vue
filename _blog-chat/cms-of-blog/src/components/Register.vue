    ...
    <section class="register">
        <validator name="loginValidator">
            <div class="form" @keyup.enter="registerRequest">
                ...
                <div class="part f-cb">
                    <div class="f-fr">
                        <input type="text" name="userName" placeholder="去除chrome自动完成" autocomplete="off"
                               style="display:none">
                        <input id="userName"
                               type="text"
                               name="userName"
                ...
                <div class="part f-cb">
                    <div class="f-fr">
                        <input type="email" name="email" placeholder="去除chrome自动完成" autocomplete="off"
                               style="display:none">
                        <input id="email"
                               type="email"
                               name="email"
                ...
                <div class="part f-cb send-email">
                    ...
                    <div class="f-fl">
                        <input type="text" name="emailCode" placeholder="去除chrome自动完成" autocomplete="off"
                               style="display:none">
                        <input id="emailCode"
                               type="text"
                               name="emailCode"
                    ...
                    <div @click="handleSendEmail" class="f-fl sendEmailBtn"
                         :class="[sendEmailState==2||sendEmailState==3? 'disabled': '']">
