    ...
    var LazySuspend = function (container, params) {
                ...
                case 'circle':
                    ...
                    for (var i = 0; i < n.items.length; i++) {
                        if (n.params.delay) {
                            ...
                            U.transitionEnd(n.items[i], function () {
        ...
        n.close = function () {
            switch (n.params.type) {
                ...
                case 'circle':
                    for (var i = 0; i < n.items.length; i++) {
                        U.setTransform(n.items[i], 'translate(0, 0)');
                        n.items[i].style.top = '0px';
        ...
        n.pageInit = function () {
            ...
            U.addEvent(n.btn, 'click', n.toggle, false);
