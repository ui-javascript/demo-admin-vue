    ...
    var RichEditor = function (container, params) {
        ...
        var options = {
            ...
            buttons: {
                ...
                insertImage: {
                    ...
                    click: function () {
                        r.closeModal();
                        var html = '<div class="editor-file">图片上传<input type="file" name="photo" accept="image/*" class="editor-file-input"/></div>';
        ...
        r.drawEmotion = function () {
            ...
            list_smilies.forEach(function (v) {
                html += '<img src=' + v + '"images/emotion/.png" class="emotion" width="20" height="20" alt="" />';
            });
