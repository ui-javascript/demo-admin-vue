...
gulp.task('less', function () {
    return gulp.src(["css/output/**/*.less","!css/output/_import.less"])
        .pipe(plumber())
        .pipe(less())
        .pipe(autoprefixer())
...
gulp.task('images', function () {
    return gulp.src('images/**/*.{png,jpg,jpeg,ico,gif,svg}')
        .pipe(plumber())
        .pipe(imagemin({
...
gulp.task('sprite', function() {
    return gulp.src('images/sprite/!(sprite.png|*.css)')
        .pipe(spritesmith({
            imgName: 'ico.png',
            cssName: 'sprite.css'
        }))
...
gulp.task('clean', function () {
    return gulp.src(['js/*','html/*'], {read: false})
        .pipe(clean())
});
