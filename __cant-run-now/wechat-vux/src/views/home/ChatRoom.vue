<template>
  <div class="app-main">
    ...
    <div class="footer">
      <div class="main">
        <input type="text" class="input" placeholder="开始愉快聊天吧!!" v-model="inputValue" @keyup.enter="sendEvent"
               v-show="connectState"/>
  ...
  export default {
    ...
    methods: {
      connectEvent() {
        ...
        // this.httpServer = io.connect('http://leaf.qmen.space:3000')
        this.httpServer = io('http://leaf.qmen.space:3000')
