<template>
  <div class="list">
    ...
    <h2>修改默认按钮</h2>
    <list-data ref='list-data' @onClickBtn="onClickBtn" @onClickBtnAdd="onClickBtnAdd"
               @onClickBtnSelect="onClickBtnSelect" @onClickBtnUpdate="onClickBtnUpdate"
               @onClickBtnDelete="onClickBtnDelete" @onClickBtnBatchDelete="onClickBtnBatchDelete"
