<template>
    <div id="app">
        ...
        <div class="martop15">
            <divider>其他</divider>
            <group>
                <cell title="自定义vue全局过滤器" value="" is-link link="vuefilter.html"></cell>
                <cell title="模块下放静态文件" value="" is-link link="bigimage.html"></cell>
                <cell title="ajax" value="" is-link link="ajax.html"></cell>
                <cell title="获取url参数" value="" is-link link="getQuery.html?goodsid=1688&shopid=25"></cell>
            </group>
        </div>
