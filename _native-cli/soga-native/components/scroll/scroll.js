...
(function () {
    var LazyIScroll = function (container, params) {
        ...
        if (!(this instanceof LazyIScroll)) {
            return new LazyIScroll(container, params);
        }
        ...
        n.refresh = function () {
            ...
            if (n.scrollTop > 0) {
                ...
                n.iscrollbar.style.opacity = 0;
                n.moveY = 0;
                setTransform(n.thumb, 'translate3d(0, ' + n.moveY + 'px, 0');
                setTransform(n.wrapper, 'translate3d(0, ' + n.moveY + 'px, 0');
            }
            requestAnimationFrame(n.refresh);
        };
