...
let url = 'http://leaf.qmen.space:8080/api/major/'
...
class DataTablePage extends React.Component {
  ...
  postOne = () => {
    ...
    axios.post(url, {
      ...
      this.fetch()
      this.props.form.resetFields() // 清空
      message.success('新增专业成功')
    })
    .catch(() => {
      this.setState({
        loading: false,
      })
      message.error('新增专业失败,请注意专业名称')
    })
  }
  ...
  render () {
    ...
    return (
      <div className="content-inner">
          ...
          <Col md={14} sm={24}>
            ...
            >
              ...
              <FormItem>
                ...
                >
                  <Option value="all">所有系部</Option>
                  <Option value="1">计算机系</Option>
                  <Option value="2">软件工程系</Option>
                </Select>
              </FormItem>
              <FormItem>
                <Button
        ...
        <Modal
          title={this.state.editingId < 0 ? '新增专业' : '修改专业信息'}
          ...
          <Form onSubmit={this.handleSubmit}>
            <Form>
              ...
              {getFieldDecorator('name', {
                ...
                <Input prefix={<Icon type="user" />} placeholder="专业名" />
              )}
              </FormItem>
              <FormItem>
              {getFieldDecorator('intro')(
                <Input prefix={<Icon type="info-circle-o" />} placeholder="专业说明" />
              )}
              </FormItem>
              <FormItem label="所属系部">
...
const MajorInfoPage = Form.create()(DataTablePage)

export default MajorInfoPage
