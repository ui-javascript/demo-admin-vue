...
let url = 'http://leaf.qmen.space:8080/api/tch/'
...
class DataTablePage extends React.Component {
  ...
  putModalHandler = (index) => {
    ...
    this.props.form.setFields({
      job_num: { value: index.job_num }, // 读取信息显示在表单上
      name: { value: index.name },
      gender: { value: index.gender },
      title: { value: index.title },
      qualification: { value: index.qualification },
      qualification_school: { value: index.qualification_school },
      degree: { value: index.degree },
      degree_school: { value: index.degree_school },
      research_area: { value: index.research_area },
      tel: { value: index.tel },
      mobile: { value: index.mobile },
  ...
  postOne = () => {
    ...
    axios.post(url, {
      id: null,
      job_num: form.getFieldValue('job_num'),
      name: form.getFieldValue('name'),
      gender: form.getFieldValue('gender'),
      title: form.getFieldValue('title'),
      qualification: form.getFieldValue('qualification'),
      qualification_school: form.getFieldValue('qualification_school'),
      degree: form.getFieldValue('degree'),
      degree_school: form.getFieldValue('degree_school'),
      research_area: form.getFieldValue('research_area'),
  ...
  putById = () => {
    ...
    axios
      ...
      .then(() => {
        ...
        this.fetch()
        message.success('修改教师信息成功')
      })
      .catch(() => {
        this.setState({ loading: false })
        message.error('修改教师信息失败')
      })
  }
  ...
  render () {
    ...
    return (
      <div className="content-inner">
        <Row>
          <Col md={10} sm={24}>
            <Form layout="inline">
              ...
              <FormItem>
                <Button type="dashed" style={{ marginRight: '3%' }} onClick={this.postModalHandler}>新增教师</Button>
              </FormItem>
              <FormItem>
          ...
          <Col md={14} sm={24}>
            ...
            >
              <FormItem>
                {(
                  <Input placeholder="输入教师工号或姓名关键词" />
                )}
              </FormItem>
              <FormItem>
                <Button
            ...
            <div>
              ...
              <Table rowSelection={rowSelection}
                columns={[{
                  ...
                  title: '最后学历毕业学院',
                  dataIndex: 'qualification_school',
                }, {
                  title: '最后学位',
                  dataIndex: 'degree',
                }, {
                  title: '最后学位毕业学院',
                  dataIndex: 'degree_school',
                }, {
                  title: '研究领域',
        ...
        <Modal
          title={this.state.editingId < 0 ? '新增教师' : '修改教师信息'}
          ...
          <Form onSubmit={this.handleSubmit}>
            <Form>
              <Form>
                ...
                <FormItem label="最后学历毕业学院">
                {getFieldDecorator('qualificationschool', {
                  rules: [{ required: true, message: '请选择相关信息！' }],
                })(
                  <Input />
                )}
                ...
                {getFieldDecorator('tel', {
                  rules: [{ required: true, message: '家庭电话不能为空！' }],
                })(
                  <Input />
                )}
                </FormItem>
...
const TchInfoPage = Form.create()(DataTablePage)

export default TchInfoPage
