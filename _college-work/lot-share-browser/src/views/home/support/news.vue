<template>
    <div class="form">
        <el-form label-width="100px" style="margin:20px;width:90%;min-width:600px;"
            ...
            :rules="rules"
            ref='refArticle'>
            <el-form-item label="讯息标题" prop='title' style="width:600px;">
                <el-input v-model="article_data.title"></el-input>
            </el-form-item>
            <el-form-item label="讯息内容" style="width:986px;" prop='content'>
                <div id="article" style="height:260px;"></div>
            </el-form-item>
            <el-form-item label="讯息分类" prop='cate'>
                <el-select v-model="article_data.cate" placeholder="请选择讯息分类">
                    <el-option value="技术"></el-option>
                    <el-option value="散文"></el-option>
                    <el-option value="其他"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="讯息标签" prop='tabs'>
                <el-select v-model="article_data.tabs" multiple placeholder="请选择讯息标签">
